...
from sklr.pairwise import PairwiseLabelRanker
...
from cal_pref.train import (
    train_plackett_luce_model,
    train_placket_luce_rpc_model,
    train_preference_model,
)
from cal_pref.evaluate import evaluate_placket_luce_model, evaluate_preference_model
...
parser.add_argument(
    ...
    help=(
        ...
        "Examples: 'uniform', 'prevalence', 'pred_mass', 'most_confident', 'sum'."
    ),
)
parser.add_argument(
    "--discrepancy",
